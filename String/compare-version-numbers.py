...
class Solution(object):
    def compareVersion(self, version1, version2):
        ...
        while i < n1 or j < n2:
            v1, v2 = 0, 0
            # find numbers before every dot, then comparing two numbers
...
class Solution2(object):
    def compareVersion(self, version1, version2):
        ...
        # Using the way of completing list until version1's length equel to version2
...
if __name__ == "__main__":
    print Solution2().compareVersion("21.0", "121.1.0")
    print Solution2().compareVersion("01", "1")
    print Solution2().compareVersion("1", "1.0")
